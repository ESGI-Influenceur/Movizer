 ...
 */
final class Version20181025154505 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, original_title VARCHAR(255) NOT NULL, poster_path VARCHAR(255) NOT NULL, backdrop_path VARCHAR(255) NOT NULL, overview LONGTEXT NOT NULL, release_date VARCHAR(255) NOT NULL, budget INT NOT NULL, runtime INT NOT NULL, status VARCHAR(255) NOT NULL, video VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
